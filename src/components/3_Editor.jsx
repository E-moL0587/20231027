  ...
  return (
    <div>
      ...
      <img
        src={image}
        alt="Captured"
        style={{ clipPath: hl_clipPath(), width: "50%" }}
      />
      <br />
      <button onClick={() => onOCR(hl_clipPath())}>次に進む</button>
      <br />
      <label>上:</label>
      <input
        type="range"
